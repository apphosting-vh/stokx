...
window.PatternScoring = (function () {
  ...
  function resolveLearnedWeights(pattern, skipBlend) {
    ...
    if (blend <= 0) return { trendHealth: 0.25, pullbackQuality: 0.25, swingPotential: 0.25, regimeAlignment: 0.25 };
    var blended = {};
    pillars.forEach(function (k) {
...
* Strategy: The base entry_score uses equal weights for the 5 pillars
     * (trendHealth, pullbackQuality, swingPotential, breakoutContinuation,
     * regimeAlignment). If we have
  ...
  function applyPatternWeights(baseResult, pattern, candles) {
    ...
    var pillars = {
      ...
      swingPotential: baseResult.swingPotential != null ? baseResult.swingPotential : (baseResult.sw != null ? baseResult.sw : 0),
      breakoutContinuation: baseResult.breakoutContinuation != null ? baseResult.breakoutContinuation : 0,
  ...
  async function applyMLEnhancement(symbol, candles, opts, baseResult, scoreResult) {
    ...
    try {
      ...
      var bxPillars = {
        trendHealth: baseResult.trendHealth != null ? baseResult.trendHealth : (baseResult.trend_health != null ? baseResult.trend_health : 0),
        pullbackQuality: baseResult.pullbackQuality != null ? baseResult.pullbackQuality : (baseResult.pullback_quality != null ? baseResult.pullback_quality : 0),
        swingPotential: baseResult.swingPotential != null ? baseResult.swingPotential : 0,
        regimeAlignment: baseResult.regimeAlignment != null ? baseResult.regimeAlignment : 0
      };
      features.trendHealth = bxPillars.trendHealth;
      features.pullbackQuality = bxPillars.pullbackQuality;
      features.swingPotential = bxPillars.swingPotential;
